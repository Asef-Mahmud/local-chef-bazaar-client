        ...
        <div>
            <div className="drawer lg:drawer-open mb-10">
                ...
                <div className="drawer-content">
                    {/* Navbar */}
                    <nav className="navbar bg-secondary/90 backdrop-blur-md w-full text-primary shadow-sm border-b border-primary/20">
                        <label htmlFor="my-drawer-4" aria-label="open sidebar" className="btn btn-square btn-ghost">
                            {/* Sidebar toggle icon */}
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeLinejoin="round" strokeLinecap="round" strokeWidth="2" fill="none" stroke="currentColor" className="my-1.5 inline-block size-4"><path d="M4 4m0 2a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2z"></path><path d="M9 4v16"></path><path d="M14 10l2 2l-2 2"></path></svg>
                        </label>
                        <Link to='/' className="btn btn-ghost text-[15px] md:text-xl font-extrabold -ms-6 md:ms-0"><img className='w-8 md:w-10 object-cover rounded-full border border-primary shadow-md' src={logo} alt="Logo of the Company" />Local Chef Bazaar Dashboard</Link>
                    </nav>
                ...
                <div className="drawer-side is-drawer-close:overflow-visible">
                    ...
                    <div className="flex min-h-full flex-col items-start bg-base-200/80 backdrop-blur-lg border-r border-primary/20 is-drawer-close:w-14 is-drawer-open:w-64 transition-all duration-300">
                        {/* Sidebar content here */}
                        <ul className="menu w-full grow gap-1 px-2 py-4">
                            {/* Home */}
                            <li>
