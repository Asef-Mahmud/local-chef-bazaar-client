        ...
        <div className='text-accent py-10 md:py-20 px-5 md:px-10 shadow-lg'>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {meals.map((meal, index) => (
                    <div
                        key={index}
                        className="rounded-2xl overflow-hidden shadow-lg bg-base-100 border border-accent hover:-translate-y-1 hover:shadow-xl transition duration-300"
                    >
                        {/* Image */}
            ...
            <div className='my-10 text-center'>
                <Link to='/meals'>
                <button className="btn mx-auto w-52 py-2 rounded-xl bg-accent text-black border border-accent hover:bg-secondary hover:text-primary hover:border hover:border-primary hover:-translate-0.5 font-semibold mt-2 hover:brightness-95 transition hover:cursor-pointer">
                    Explore More
                </button>
                </Link>
            </div>
